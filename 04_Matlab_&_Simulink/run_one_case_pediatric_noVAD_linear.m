function result_row = run_one_case_pediatric_noVAD_linear(sample_row, model)
...
try
    %% ------------------------------------------------------------
    % 1. Patient fixed targets — pediatric DCM patient 01
    %% ------------------------------------------------------------
    ...
    error_dir = fullfile('..', '01_Data', 'simulation_results', ...
        'pediatric_dcm_patient_01', 'errors');
...
result_row = table( ...
    ...
    sample_row.k_Vtot, ...
    sample_row.k_Vsys, ...
    sample_row.k_Vusv_sys, ...
    sample_row.k_Vusv_sys_ven, ...
    sample_row.k_Vusv_pulm_ven, ...
    sample_row.k_Ctot, ...
    sample_row.k_Csys, ...
    sample_row.k_Rsysven, ...
    sample_row.k_Rpulmart, ...
    sample_row.k_ESP_LV, ...
    sample_row.k_ESP_RV, ...
    LAP_real, ...
    RAP_real, ...
