...
%RUN_10K_SUPERCOMPUTER_PEDIATRIC_NOVAD_LINEAR
%
% Dedicated chunk runner for the 10k supercomputer campaign.
% One SLURM array task calls this function on one CSV chunk.
%
% Inputs:
...
%   run_one_case_pediatric_noVAD_linear(sample_row, model)
    ...
    fprintf("\nStarting 10k supercomputer MATLAB chunk...\n");
    ...
    %% ------------------------------------------------------------
    % 3. Run simulations sequentially inside this chunk
    %% ------------------------------------------------------------
    ...
    for i = 1:n_cases
        ...
        fprintf("\nRunning %d/%d | simulation_id = %d\n", ...
            i, n_cases, sample_row.simulation_id);
    ...
    fprintf("\nFinished 10k supercomputer chunk.\n");
